...
return array(
	...
	*/
	...
	"min"                  => array(
		"numeric" => "El :attribute debe tener a lo menos :min enteros.",
		"file"    => "The :attribute must be at least :min kilobytes.",
		"string"  => "El campo :attribute debe tener a lo menos :min caracteres.",
		"array"   => "The :attribute must have at least :min items.",
	),
	"not_in"               => "The selected :attribute is invalid.",
	"numeric"              => "El campo :attribute de registros debe tener solo numeros.",
	...
	"same"                 => "Ambas contraseñas deben coincidir.",
	"size"                 => array(
